...
class ExternalAuthenticator extends Authenticator {
  ...
  protected static function on_register() {
      Object::add_extension('Member', 'ExternalAuthenticatedMember');
      Object::add_extension('Member_Validator', 'ExternalAuthenticatedMember_Validator');
  ...
  public static function authenticate($RAW_data, Form $form = null) {
      ...
      foreach ($A_sources as $RAW_source) {
          ...
          if ($member = DataList::create('Member')->filter(
                  array('External_UserID' => $SQL_identity,
                      'External_SourceID' => $SQL_source))->First()) {
              $userexists = true;
